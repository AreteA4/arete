...
mod tests {
    ...
    /// Golden test: drive codegen from the exact Ore artifact closure and
    /// assert the expected handlers and PDA configs appear. This
    /// exercises the artifact-to-TypeScript path against actual data
