...
A **stack** is the deployed data pipeline plus its generated client definition. Generate the TypeScript definition with the CLI rather than hand-writing view factories:

```bash
a4 sdk create typescript my-tokens
```
