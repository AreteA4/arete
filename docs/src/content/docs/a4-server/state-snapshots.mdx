...
to snapshots with a different format version, mismatched program ids, a
[commitment](/a4-server/reference/#yellowstone-commitment) weaker than the
runtime's, or corrupt/truncated blobs — restore problems never block startup.
