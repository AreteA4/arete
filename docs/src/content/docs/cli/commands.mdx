...
The generated SDK does not point at your deployment. Pass the WebSocket
endpoint `a4 up` prints to the client, for example
`useArete(stack, { url })` in TypeScript, where `stack` is the generated stack definition.
