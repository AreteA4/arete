...
| Agent guidance     | `AGENTS.md`                                          | A managed block between `<!-- BEGIN:arete v1 -->` and `<!-- END:arete -->`; content outside the markers is never touched                               |
...
| `agents.<id>.skills`    | `arete`, `arete-consume`, `arete-build` installed for that agent       | `warn`: `npx skills add AreteA4/skills --agent <id>` |
| `agents.agents-md`      | `AGENTS.md` block present and current (`v1`)                           | `warn`: `a4 doctor --fix`                            |
