...
<Tabs>
<TabItem label="Connect with React">

### Scaffold a React Vite app for the stack
...
### Configure the React AreteProvider
...
### Scaffold a TypeScript Node project for the stack
...
### Stream ORE rounds from TypeScript
