...
resulting SDK. A declarative [Stack Source YAML](/building-stacks/stack-source/)
path is in preview and is intended to become the normal route for read models
that fit its supported feature set.
