...
Arete's transaction transport lets an application inspect, submit, and confirm
transactions through the transaction descriptor embedded in a generated stack
or Program SDK. It is independent of the live-view and Program Read endpoints.
The wallet still compiles and signs locally. Arete never receives a private key
