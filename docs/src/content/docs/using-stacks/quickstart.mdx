...
<TabItem label="Install via Cargo">
...
<Tabs syncKey="creator">
<TabItem label="Create with Cargo">
...
<Tabs syncKey="template-flag">
<TabItem label="Template flag (Cargo)">
...
<TabItem label="Template flag (npx)">
...
<TabItem label="Template flag (npm)">
