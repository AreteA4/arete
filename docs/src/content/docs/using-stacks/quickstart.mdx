...
<Tabs>
<TabItem label="Prerequisites — Cargo (Rust)">
...
<TabItem label="Prerequisites — npx (no install)">
...
<TabItem label="Prerequisites — npm (global)">
...
<Tabs>
<TabItem label="Create app — Cargo (Rust)">
...
<TabItem label="Create app — npx (no install)">
...
<TabItem label="Create app — npm (global)">
...
<Tabs>
<TabItem label="Template flag — Cargo (Rust)">
...
<TabItem label="Template flag — npx (no install)">
...
<TabItem label="Template flag — npm (global)">
