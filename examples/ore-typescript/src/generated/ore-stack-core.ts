...
export const ORE_STREAM_STACK_CORE = {
  ...
  programs: {
    ore: {
      name: 'ore',
      programId: 'oreV3EG1i9BEgiAJ8b177Z2S2rMarzak4NMv1kULvWv',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:45d57f86cabc41096490dd26e13bbaf9db8fbceafcd63eb7929276aba88c9021',
    ...
    entropy: {
      name: 'entropy',
      programId: '3jSkUuYBoJzQPMEzTvkDFXCZUBksPamrVhrnHR9igu2X',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:87ced6d050c43f5ea492db812423b48956d8200f3cfb3db30de1e3adfc71f106',
