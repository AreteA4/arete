...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={toggleTheme}
      className="grid min-h-11 min-w-11 place-items-center rounded-full bg-white shadow-sm transition-shadow hover:shadow-md dark:bg-stone-800 dark:ring-1 dark:ring-stone-700"
