...
export const ORE_STREAM_STACK_CORE = {
  ...
  programs: {
    ore: {
      name: 'ore',
      programId: 'oreV3EG1i9BEgiAJ8b177Z2S2rMarzak4NMv1kULvWv',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:61bccb7b7a5b909408222cef2520e216aee83b77a5340236d388b1abbd21a43d',
    ...
    entropy: {
      name: 'entropy',
      programId: '3jSkUuYBoJzQPMEzTvkDFXCZUBksPamrVhrnHR9igu2X',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:13feb21295498773cbac6325bfdc9e3adb24df22000036b7ba748512888cd9b4',
