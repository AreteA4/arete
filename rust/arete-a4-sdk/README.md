...
```toml
[dependencies]
arete-sdk = { package = "arete-a4-sdk", version = "0.20.2" } # x-release-please-version
```
...
```toml
arete-sdk = { package = "arete-a4-sdk", version = "0.20.2", features = ["solana-adapter"] } # x-release-please-version
```
