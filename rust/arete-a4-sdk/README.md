...
```toml
[dependencies]
arete-sdk = { package = "arete-a4-sdk", version = "0.22.4" } # x-release-please-version
```
...
```toml
arete-sdk = { package = "arete-a4-sdk", version = "0.22.4", features = ["solana-adapter"] } # x-release-please-version
```
