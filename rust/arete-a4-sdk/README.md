...
```toml
[dependencies]
arete-sdk = { package = "arete-a4-sdk", version = "0.19.0" } # x-release-please-version
```
...
```toml
arete-sdk = { package = "arete-a4-sdk", version = "0.19.0", features = ["solana-adapter"] } # x-release-please-version
```
