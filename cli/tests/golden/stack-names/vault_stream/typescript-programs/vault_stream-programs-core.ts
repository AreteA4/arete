...
export const VAULT = {
  name: 'vault',
  programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
  sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:b00b9649bbdc7aadd725090c6f93cef12157c39ea453c4e56f692ce1a8de2d1f',
...
/** All portable programs from the vault_stream stack */
export const VAULT_STREAM_PROGRAMS = {
  vault: VAULT,
} as const;

/** Parallel release/read metadata keyed identically to VAULT_STREAM_PROGRAMS */
export const VAULT_STREAM_PROGRAM_READS = {
  vault: VAULT_READ,
} as const;
