...
export type VaultStreamAlphaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const VAULT_STREAM_ALPHA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = VaultStreamAlphaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: VAULT_STREAM_ALPHA_PROGRAM_ERRORS,
});
...
/** Stack definition for VaultStreamAlpha with 1 entities */
export const VAULT_STREAM_ALPHA_STACK_CORE = {
  name: 'vault-stream-alpha',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:89e80d0695eecd98d1575d689fe17938064edbd7a0233def4c834cfaefca7db0',
...
export type VaultStreamAlphaCoreStack = typeof VAULT_STREAM_ALPHA_STACK_CORE;

/** Entity types in this stack */
export type VaultStreamAlphaEntity = Vault;

/** Default export for convenience */
export default VAULT_STREAM_ALPHA_STACK_CORE;