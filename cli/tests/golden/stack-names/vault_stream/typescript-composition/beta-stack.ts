...
export type VaultStreamBetaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const VAULT_STREAM_BETA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = VaultStreamBetaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: VAULT_STREAM_BETA_PROGRAM_ERRORS,
});
...
/** Stack definition for VaultStreamBeta with 1 entities */
export const VAULT_STREAM_BETA_STACK_CORE = {
  name: 'vault-stream-beta',
  endpoints: {
...
export type VaultStreamBetaCoreStack = typeof VAULT_STREAM_BETA_STACK_CORE;

/** Entity types in this stack */
export type VaultStreamBetaEntity = Vault;

/** Default export for convenience */
export default VAULT_STREAM_BETA_STACK_CORE;