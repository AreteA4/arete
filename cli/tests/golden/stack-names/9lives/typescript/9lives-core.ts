...
/** Stack definition for 9lives with 1 entities */
export const A9LIVES_STACK_CORE = {
  name: '9lives',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:72995209552b6cb7ddc2f86d5c997263db7d83c39d93c96f27c53294ede3996d',
...
export type A9livesCoreStack = typeof A9LIVES_STACK_CORE;

/** Entity types in this stack */
export type A9livesEntity = Vault;

/** Default export for convenience */
export default A9LIVES_STACK_CORE;