...
export type A9livesAlphaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const A9LIVES_ALPHA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = A9livesAlphaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: A9LIVES_ALPHA_PROGRAM_ERRORS,
});
...
/** Stack definition for A9livesAlpha with 1 entities */
export const A9LIVES_ALPHA_STACK_CORE = {
  name: 'a9lives-alpha',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:0af2570c054196249dd496cec82949c10914b31baced17be7bb32217645fa84b',
...
export type A9livesAlphaCoreStack = typeof A9LIVES_ALPHA_STACK_CORE;

/** Entity types in this stack */
export type A9livesAlphaEntity = Vault;

/** Default export for convenience */
export default A9LIVES_ALPHA_STACK_CORE;