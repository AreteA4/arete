...
export type A9livesBetaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const A9LIVES_BETA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = A9livesBetaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: A9LIVES_BETA_PROGRAM_ERRORS,
});
...
/** Stack definition for A9livesBeta with 1 entities */
export const A9LIVES_BETA_STACK_CORE = {
  name: 'a9lives-beta',
  endpoints: {
...
export type A9livesBetaCoreStack = typeof A9LIVES_BETA_STACK_CORE;

/** Entity types in this stack */
export type A9livesBetaEntity = Vault;

/** Default export for convenience */
export default A9LIVES_BETA_STACK_CORE;