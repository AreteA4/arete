...
export type MyStackBetaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const MY_STACK_BETA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = MyStackBetaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: MY_STACK_BETA_PROGRAM_ERRORS,
});
...
/** Stack definition for MyStackBeta with 1 entities */
export const MY_STACK_BETA_STACK_CORE = {
  name: 'my-stack-beta',
  endpoints: {
...
export type MyStackBetaCoreStack = typeof MY_STACK_BETA_STACK_CORE;

/** Entity types in this stack */
export type MyStackBetaEntity = Vault;

/** Default export for convenience */
export default MY_STACK_BETA_STACK_CORE;