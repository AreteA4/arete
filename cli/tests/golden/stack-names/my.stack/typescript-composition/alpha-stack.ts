...
export type MyStackAlphaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const MY_STACK_ALPHA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = MyStackAlphaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: MY_STACK_ALPHA_PROGRAM_ERRORS,
});
...
/** Stack definition for MyStackAlpha with 1 entities */
export const MY_STACK_ALPHA_STACK_CORE = {
  name: 'my-stack-alpha',
  endpoints: {
...
export type MyStackAlphaCoreStack = typeof MY_STACK_ALPHA_STACK_CORE;

/** Entity types in this stack */
export type MyStackAlphaEntity = Vault;

/** Default export for convenience */
export default MY_STACK_ALPHA_STACK_CORE;