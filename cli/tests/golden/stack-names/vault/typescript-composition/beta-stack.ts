...
export type VaultBetaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const VAULT_BETA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = VaultBetaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: VAULT_BETA_PROGRAM_ERRORS,
});
...
/** Stack definition for VaultBeta with 1 entities */
export const VAULT_BETA_STACK_CORE = {
  name: 'vault-beta',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:758a22b03b02b0ef34ff8780fe29d7cc0d2a2df0f19bc4b195505c73a3d23a88',
...
export type VaultBetaCoreStack = typeof VAULT_BETA_STACK_CORE;

/** Entity types in this stack */
export type VaultBetaEntity = Vault;

/** Default export for convenience */
export default VAULT_BETA_STACK_CORE;