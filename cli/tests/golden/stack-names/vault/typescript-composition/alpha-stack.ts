...
export type VaultAlphaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const VAULT_ALPHA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = VaultAlphaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: VAULT_ALPHA_PROGRAM_ERRORS,
});
...
/** Stack definition for VaultAlpha with 1 entities */
export const VAULT_ALPHA_STACK_CORE = {
  name: 'vault-alpha',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:6cd09f53c626916ae006338b028a93dee6fc85751e5f167727acecfee6515f75',
...
export type VaultAlphaCoreStack = typeof VAULT_ALPHA_STACK_CORE;

/** Entity types in this stack */
export type VaultAlphaEntity = Vault;

/** Default export for convenience */
export default VAULT_ALPHA_STACK_CORE;