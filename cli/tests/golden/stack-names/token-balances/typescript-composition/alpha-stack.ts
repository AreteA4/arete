...
export type TokenBalancesAlphaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const TOKEN_BALANCES_ALPHA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = TokenBalancesAlphaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: TOKEN_BALANCES_ALPHA_PROGRAM_ERRORS,
});
...
/** Stack definition for TokenBalancesAlpha with 1 entities */
export const TOKEN_BALANCES_ALPHA_STACK_CORE = {
  name: 'token-balances-alpha',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:2610dd4c9c31abdd3e92a0d582e86e762a6d4a3a541f45e32d3c2c3c0ce08dc3',
...
export type TokenBalancesAlphaCoreStack = typeof TOKEN_BALANCES_ALPHA_STACK_CORE;

/** Entity types in this stack */
export type TokenBalancesAlphaEntity = Vault;

/** Default export for convenience */
export default TOKEN_BALANCES_ALPHA_STACK_CORE;