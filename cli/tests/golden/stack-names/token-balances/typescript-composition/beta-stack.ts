...
export type TokenBalancesBetaProgramError =
  | { code: 0; name: 'AmountTooSmall'; msg: string };

const TOKEN_BALANCES_BETA_PROGRAM_ERRORS: ErrorMetadata[] = [
...
export type DepositError = TokenBalancesBetaProgramError;
...
export const depositInstruction = createInstructionHandler<DepositParams, DepositError>({
  ...
  errors: TOKEN_BALANCES_BETA_PROGRAM_ERRORS,
});
...
/** Stack definition for TokenBalancesBeta with 1 entities */
export const TOKEN_BALANCES_BETA_STACK_CORE = {
  name: 'token-balances-beta',
  endpoints: {
  ...
  programs: {
    vault: {
      name: 'vault',
      programId: '2c35Vf2AKSi7mTvaNdhSrgE3ppGAEyeSSLWNRkxbrQQM',
      sdkDefinitionHash: 'arete:h1:sdk-definition:sha256:8284f161440d091228572ad97d630ca0109ee4e1f5e92420d0a0bc4b88bbc35d',
...
export type TokenBalancesBetaCoreStack = typeof TOKEN_BALANCES_BETA_STACK_CORE;

/** Entity types in this stack */
export type TokenBalancesBetaEntity = Vault;

/** Default export for convenience */
export default TOKEN_BALANCES_BETA_STACK_CORE;