...
/** Stack definition for token-balances with 1 entities */
export const TOKEN_BALANCES_STACK_CORE = {
  name: 'token-balances',
  endpoints: {
...
export type TokenBalancesCoreStack = typeof TOKEN_BALANCES_STACK_CORE;

/** Entity types in this stack */
export type TokenBalancesEntity = Vault;

/** Default export for convenience */
export default TOKEN_BALANCES_STACK_CORE;